...
public abstract class ListadoData extends DataAdapter implements Serializable
{
  ...
  /**
     ...
     *
     */
  public void pushData(org.fundaciobit.administraciodigital.utils.data.Data data)
  {
    vRes.add(data);
  }
  ...
  /**
     ...
     *
     */
  public org.fundaciobit.administraciodigital.utils.data.Data getData(int pos)
  {
    return (org.fundaciobit.administraciodigital.utils.data.Data) vRes.get(pos);
  }
