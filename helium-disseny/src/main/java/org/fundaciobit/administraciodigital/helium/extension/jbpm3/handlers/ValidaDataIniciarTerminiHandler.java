 ...
 */
package org.fundaciobit.administraciodigital.helium.extension.jbpm3.handlers;
...
public class ValidaDataIniciarTerminiHandler extends TerminiIniciarHandler {
    ...
    public void execute(ExecutionContext context) throws Exception {
        ...
        if ("true".equals(autoLeave)) context.leaveNode();
    ...
    public void setAutoLeave(String autoLeave){
